-- Fixes compatibility breakdown orientation.
-- The cached pair is stored once as user_a/user_b, but the API must return
-- mismatch answers oriented to the viewer so "Tu respuesta" is always correct.
