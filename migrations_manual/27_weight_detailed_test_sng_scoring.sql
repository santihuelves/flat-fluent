...
-- =====================================================================
-- Objetivo:
--   Afinar el score del test exhaustivo separando las preguntas en
--     S = similitud de estilo
--     N = señales saludables (responsabilidad, comunicación, gestión)
--     G = gates / límites sensibles (privacidad, fumar, comida, visitas)
--   Las preguntas tienen distinto peso y los gates pueden penalizar
--   directamente el resultado cuando las respuestas chocan.

-- 1) Helpers de clasificación de pregunta ------------------------------
...
AS $$
  SELECT CASE p_question_id
    -- Gates: límites sensibles (privacidad, fumar, visitas, comida)
    ...
    -- Señales saludables: responsabilidad, comunicación, gestión, espacios comunes
    ...
    -- Estilo: descanso, flexibilidad, comunicación general
...
-- 2) Matriz de similitud actualizada -----------------------------------
...
-- 3) compute_and_cache_guarded con modelo S/N/G ------------------------
...
BEGIN
  ...
  -- Combinar bloques S/N/G con pesos 0.35 / 0.40 / 0.25
  ...
  -- Penalización por gates: si gates < 0.7, aplicar resta proporcional (hasta -40)
