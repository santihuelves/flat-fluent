-- =====================================================================
-- BLOQUE 23 - Restaurar matriz de similitud del test
-- =====================================================================
-- Antes: respuestas categóricas distintas puntuaban 0 aunque fueran
-- semánticamente cercanas (p.ej. system vs occasional_flex), causando
-- compatibilidades 0% injustas.
-- Ahora: una matriz de similitud reconoce respuestas cercanas con
-- puntuaciones parciales.

-- 1) Helper: similitud entre dos respuestas del test
...
BEGIN
  ...
  -- Pareja ordenada para lookup simétrico
  IF a_norm < b_norm THEN
    pair := a_norm || '|' || b_norm;
  ELSE
    pair := b_norm || '|' || a_norm;
...
-- 2) Recompute con nueva matriz + nuevo scoring_model
...
-- Invalidar cachés con modelo distinto
