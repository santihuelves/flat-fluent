...
BEGIN
  ...
  INSERT INTO public.convinter_listings (
    ...
    p_min_stay_months, COALESCE(p_smoking_allowed, false), COALESCE(p_pets_allowed, false),
    p_photos,
...
BEGIN
  ...
  SET
    ...
    thumbnail_url = CASE
      WHEN p_photos IS NOT NULL AND array_length(p_photos, 1) > 0 THEN p_photos[1]
      ELSE thumbnail_url
    END,
