-- Fix match loading by keeping consent rows and profile rows in separate records.
...
BEGIN
  ...
  LOOP
    ...
    WHERE (user_a = least(me, consent_record.other_user) AND user_b = greatest(me, consent_record.other_user))
